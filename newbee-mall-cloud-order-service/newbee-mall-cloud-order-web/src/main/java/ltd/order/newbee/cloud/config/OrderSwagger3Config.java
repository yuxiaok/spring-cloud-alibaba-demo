...
@Configuration
@EnableOpenApi
public class OrderSwagger3Config {

	@Bean
	public Docket api() {
		return new Docket(DocumentationType.OAS_30)
				.apiInfo(apiInfo())
				.ignoredParameterTypes(MallUserToken.class, LoginAdminUser.class)
				.select()
				.apis(RequestHandlerSelectors.basePackage("ltd.order.newbee.cloud.controller"))
