...
import ltd.order.newbee.cloud.controller.param.BatchIdParam;
...
public class NewBeeAdminOrderAPI {
	...
	public Result<NewBeeMallOrderDetailVO> orderDetailPage(@ApiParam(value = "订单号") @PathVariable("orderId") Long orderId,
