 ...
 * 版权所有，侵权必究！
 */
package ltd.shopcart.newbee.cloud.service;
...
public interface NewBeeMallShoppingCartService {
	...
	List<NewBeeMallShoppingCartItemDTO> getCartItemsByCartIds(List<Long> cartItemIds);

	Integer deleteCartItemsByCartIds(List<Long> cartItemIds);
}
