...
import ltd.goods.newbee.cloud.controller.param.GoodsCategoryAddParam;
import ltd.goods.newbee.cloud.controller.param.GoodsCategoryEditParam;
...
public class NewBeeAdminGoodsCategoryController {
	 ...
	 * 列表
	 */
	@RequestMapping(value = "4Select", method = RequestMethod.GET)
